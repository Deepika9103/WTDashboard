    ...
    useEffect(() => {
      const handleScroll = () => {
        ...
        if (servicesSection) {
          ...
          const servicesSectionHeight = servicesSection.clientHeight;
  
          setIsInView(scrollY > servicesSectionTop - servicesSectionHeight / 2);
        }
      };
